...
>
> **2026-09-13 收敛（R1/R2 清零）**：登记表 36 → **5**（R1 10→0、R2 5→0、R3 20→4、R5 类 1→1）。
> 落地明细、与新计划的对账、以及对本文 §3–§5 表格的逐条销账见
> `docs/game-提取到-core-ops-计划-2026-09-13.md` §9（实施结果）。**本文以下内容为历史裁决记录，保留原貌。**
