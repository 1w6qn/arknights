...
const expectedPrefixes: Array<[string, string]> = [
  ...
  ["/building", "./modules/building/routes"],
  ["/quest", "./modules/quest/routes"],
  ["/user", "./modules/user/routes"],
  ["/activity", "./modules/activities"],
  ["/storyreview", "./modules/storyreview/routes"],
  ["/mission", "./modules/mission/routes"],
  ["/shop", "./modules/shop/routes"],
  ["/rlv2", "./modules/roguelike/rlv2.routes"],
  ["/gacha", "./modules/gacha/routes"],
  ...
  ["/plugin", "./modules/system/plugin.routes"],
